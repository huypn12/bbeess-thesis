...
CTMC is a strong formalism to model systems with regarding to real-time properties. In this thesis,
...
checking is to simulate a number of traces from $\mathcal{M}$, monitor if each trace satisfies $\Phi$, then
...
\textit{qualitative} and \textit{quantitative} problem\footnote{\url{https://www-verimag.imag.fr/Statistical-Model-Checking-814.html\#nb3}}:
\begin{enumerate}
